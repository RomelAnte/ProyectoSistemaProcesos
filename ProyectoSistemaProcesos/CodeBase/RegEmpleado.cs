...
namespace ProyectoSistemaProcesos.CodeBase
{
    internal class RegEmpleado
    {
        ...
        public Empleado BuscarEmpleado(string ci)
        {
                    ...
                    using (MySqlCommand command = new MySqlCommand(query1, _connection))
                    {
                        ...
                        using (MySqlDataReader reader = command.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                                ...
                                empleado.ci = reader.GetString("CI_Maqui");
                                empleado.nombre = reader.GetString("nom_Maqui");
                                empleado.apellido = reader.GetString("apell_Maqui");
                                empleado.fechaNaci = reader.GetString("fechaNaci");
                                empleado.email = reader.GetString("mail_Maqui");
                                empleado.fono = reader.GetString("fono_Maqui");
                                empleado.direcc = reader.GetString("direc_Maqui");
                                empleado.cargo = reader.GetString("cargo_Maqui");
                                empleado.Estado = reader.GetBoolean("E_Maqui");
